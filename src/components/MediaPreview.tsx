          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-4 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3">
              {previewItems.map((mediaItem) => (
                <div
                  key={mediaItem.id}
                  className="relative aspect-square bg-accent/20 rounded-lg overflow-hidden"
                >
            ...
            <div className="flex space-x-3">
              <button
                onClick={onViewAll}
                className="flex-1 px-4 py-2 bg-accent/20 rounded-lg hover:bg-accent transition-colors text-sm font-medium flex items-center justify-center gap-2"
              >

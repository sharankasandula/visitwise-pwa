...
const ArchivedPatients: React.FC = () => {
  ...
  return (
    <div className="min-h-screen">
      {/* Header */}
      <div className="bg-primary-600 text-gray-700 px-4 pt-4">
      ...
      <div className="px-4 py-4">
        <input
          ...
          className="w-full p-3 rounded-lg shadow-md border border-gray-200 focus:outline-none focus:ring-2 focus:ring-primary-500"
        />
      </div>
